! function(t) {
    ...
    ! function(r) {
        ...
        u.prototype = {
            ...
            _resolveViewName: function(e) {
                return t.each(v.viewModes, function(i, a) {
            ...
            _process_options: function(e) {
                ...
                if (s.defaultViewDate instanceof Date || "string" == typeof s.defaultViewDate) s.defaultViewDate = v.parseDate(s.defaultViewDate, r, s.language, s.assumeNearbyYear);
            ...
            update: function() {
                ...
                }, this)), a = !0) : (i = this.isInput ? this.element.val() : this.element.data("date") || this.inputField.val(), i = i && this.o.multidate ? i.split(this.o.multidateSeparator) : [i], delete this.element.data().date), i = t.map(i, t.proxy(function(t) {
            ...
            fillMonths: function() {
                for (var t = this._utc_to_local(this.viewDate), e = "", i = 0; i < 12; i++) e += '<span class="month' + (t && t.getMonth() === i ? " focused" : "") + '">' + m[this.o.language].monthsShort[i] + "</span>";
            ...
            _fill_yearsView: function(i, a, s, n, r, o, l) {
                for (var h, u, c, d = "", p = s / 10, f = this.picker.find(i), g = Math.floor(n / s) * s, m = g + 9 * p, v = Math.floor(this.viewDate.getFullYear() / p) * p, y = t.map(this.dates, function(t) {
                        return Math.floor(t.getUTCFullYear() / p) * p
                    }), w = g - p; w <= m + p; w += p) h = [a], u = null, w === g - p ? h.push("old") : w === m + p && h.push("new"), -1 !== t.inArray(w, y) && h.push("active"), (w < r || w > o) && h.push("disabled"), w === v && h.push("focused"), l !== t.noop && ((c = l(new Date(w, 0, 1))) === e ? c = {} : "boolean" == typeof c ? c = {
                    enabled: c
                } : "string" == typeof c && (c = {
                    classes: c
                }), !1 === c.enabled && h.push("disabled"), c.classes && (h = h.concat(c.classes.split(/\s+/))), c.tooltip && (u = c.tooltip)), d += '<span class="' + h.join(" ") + '"' + (u ? ' title="' + u + '"' : "") + ">" + w + "</span>";
            ...
            fill: function() {
                ...
                if (!isNaN(r) && !isNaN(o)) {
                    this.picker.find(".datepicker-days .datepicker-switch").text(v.formatDate(n, f, this.o.language)), this.picker.find("tfoot .today").text(d).css("display", !0 === this.o.todayBtn || "linked" === this.o.todayBtn ? "table-cell" : "none"), this.picker.find("tfoot .clear").text(p).css("display", !0 === this.o.clearBtn ? "table-cell" : "none"), this.picker.find("thead .datepicker-title").text(this.o.title).css("display", "string" == typeof this.o.title && "" !== this.o.title ? "table-cell" : "none"), this.updateNavArrows(), this.fillMonths();
                    var g = i(r, o, 0),
                        y = g.getUTCDate();
                    ...
                    for (var D, b, k = []; g.valueOf() < w;) {
                        if ((D = g.getUTCDay()) === this.o.weekStart && (k.push("<tr>"), this.o.calendarWeeks)) {
                        ...
                        this.o.beforeShowDay !== t.noop && ((s = this.o.beforeShowDay(this._utc_to_local(g))) === e ? s = {} : "boolean" == typeof s ? s = {
                            ...
                            classes: s
                        }), !1 === s.enabled && b.push("disabled"), s.classes && (b = b.concat(s.classes.split(/\s+/))), s.tooltip && (a = s.tooltip), s.content && (M = s.content)), b = t.isFunction(t.uniqueSort) ? t.uniqueSort(b) : t.unique(b), k.push('<td class="' + b.join(" ") + '"' + (a ? ' title="' + a + '"' : "") + ' data-date="' + g.getTime().toString() + '">' + M + "</td>"), a = null, D === this.o.weekEnd && k.push("</tr>"), g.setUTCDate(g.getUTCDate() + 1)
                    }
                    ...
                    if (t.each(this.dates, function(t, e) {
                        ...
                        }), (r < l || r > u) && U.addClass("disabled"), r === l && U.slice(0, h).addClass("disabled"), r === u && U.slice(c + 1).addClass("disabled"), this.o.beforeShowMonth !== t.noop) {
                        var E = this;
            ...
            moveMonth: function(t, e) {
                ...
                var i, a, s = new Date(t.valueOf()),
                    ...
                    o = s.getUTCMonth(),
                    l = Math.abs(e);
                if (e = e > 0 ? 1 : -1, 1 === l) a = -1 === e ? function() {
                    return s.getUTCMonth() === o
                } : function() {
                    return s.getUTCMonth() !== i
                }, i = o + e, s.setUTCMonth(i), i = (i + 12) % 12;
                else {
            ...
            p = function(i) {
                ...
                if (this.each(function() {
                        ...
                        if (!n) {
                            ...
                            }), n = new c(this, p)) : n = new u(this, p), e.data("datepicker", n)
                        }
        ...
        var m = t.fn.datepicker.dates = {
            ...
            v = {
                ...
                parseDate: function(i, s, n, r) {
                    ...
                    if ("string" == typeof s && (s = v.parseFormat(s)), s.toValue) return s.toValue(i, s, n);
                    var h, c, d, p, f, g = {
                            d: "moveDay",
                            m: "moveMonth",
                            w: "moveWeek",
                    ...
                    if (i in y && (i = y[i]), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(i)) {
                        for (h = i.match(/([\-+]\d+)([dmwy])/gi), i = new Date, p = 0; p < h.length; p++) c = h[p].match(/([\-+]\d+)([dmwy])/i), d = Number(c[1]), f = g[c[2].toLowerCase()], i = u.prototype[f](i, d);
                    ...
                    var x = s.parts.slice();
                    if (h.length !== x.length && (x = t(x).filter(function(e, i) {
                            return -1 !== t.inArray(i, k)
                        }).toArray()), h.length === x.length) {
                        var S;
                        for (p = 0, S = x.length; p < S; p++) {
                            if (w = parseInt(h[p], 10), c = x[p], isNaN(w)) switch (c) {
                                case "MM":
                                    D = t(m[n].months).filter(l), w = t.inArray(D[0], m[n].months) + 1;
                                    break;
                                case "M":
                                    D = t(m[n].monthsShort).filter(l), w = t.inArray(D[0], m[n].monthsShort) + 1
                            }
                            b[c] = w
                        }
                        var _, M;
                        for (p = 0; p < k.length; p++)(M = k[p]) in b && !isNaN(b[M]) && (_ = new Date(i), C[M](_, b[M]), isNaN(_) || (i = _))
                    }
                    return i
                },
                formatDate: function(e, i, a) {
                    if (!e) return "";
                    if ("string" == typeof i && (i = v.parseFormat(i)), i.toDisplay) return i.toDisplay(e, i, a);
                    var s = {
                        d: e.getUTCDate(),
    ...
    jQuery && "undefined" != typeof jQuery && (jQuery.fn.customSlider = function(t) {
        var e = "";
        if (void 0 === t) throw new Error("error" + e);
        if ([{
                prop: "start",
                example: "start: [25, 70]"
            }, {
                ...
                if (void 0 === t[i.prop]) throw new Error("error" + i.prop + "` property passed in the configuration object. For example: `" + i.example + "`" + e)
    ...
    var a, s, n;
    ! function(i) {
        s = [], void 0 !== (n = "function" == typeof(a = i) ? a.apply(e, s) : a) && (t.exports = n)
    }(function() {
        "use strict";
        ...
        function n(t, e) {
            var i = t.getBoundingClientRect(),
                ...
                s = a.documentElement,
                n = f(a);
            return /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (n.x = 0), e ? i.top + n.y - s.clientTop : i.left + n.x - s.clientLeft
        }
        ...
        function C(t, e, i) {
            ...
            var a, s, n, r, o = k(i, t);
            return a = t[o - 1], s = t[o], n = e[o - 1], r = e[o], n + D([a, s], i) / y(n, r)
        }

        function x(t, e, i) {
            if (i >= 100) return t.slice(-1)[0];
            var a, s, n, r, o = k(i, e);
            return a = t[o - 1], s = t[o], n = e[o - 1], r = e[o], b([a, s], (i - n) * y(n, r))
        }

        function S(t, e, i, a) {
            if (100 === a) return a;
            var n, r, o = k(a, t);
            return i ? (n = t[o - 1], r = t[o], a - n > (r - n) / 2 ? r : n) : e[o - 1] ? t[o - 1] + s(a - t[o - 1], e[o - 1]) : a
        }

        function _(t, e, i) {
            var a;
            if ("number" == typeof e && (e = [e]), "[object Array]" !== Object.prototype.toString.call(e)) throw new Error("noUiSlider (" + G + "): 'range' contains invalid value.");
            if (a = "min" === t ? 0 : "max" === t ? 100 : parseFloat(t), !r(a) || !r(e[0])) throw new Error("noUiSlider (" + G + "): 'range' value isn't numeric.");
            i.xPct.push(a), i.xVal.push(e[0]), a ? i.xSteps.push(!isNaN(e[1]) && e[1]) : isNaN(e[1]) || (i.xSteps[0] = e[1]), i.xHighestCompleteStep.push(0)
        }

        function M(t, e, i) {
            if (!e) return !0;
            i.xSteps[t] = w([i.xVal[t], i.xVal[t + 1]], e) / y(i.xPct[t], i.xPct[t + 1]);
        ...
        function T(t, e, i) {
            ...
            for (s.length && "object" == typeof s[0][0] ? s.sort(function(t, e) {
                    ...
                    return t[0] - e[0]
                }), a = 0; a < s.length; a++) _(s[a][1], s[a][0], this);
            for (this.xNumSteps = this.xSteps.slice(0), a = 0; a < this.xNumSteps.length; a++) M(a, this.xNumSteps[a], this)
        }
        ...
        function E(t, e) {
            if (!r(e)) throw new Error("noUiSlider (" + G + "): 'step' is not numeric.");
            t.singleStep = e
        }
        ...
        function V(t, e) {
            if (e = h(e), !Array.isArray(e) || !e.length) throw new Error("noUiSlider (" + G + "): 'start' option is incorrect.");
        ...
        function W(t, e) {
            if (!r(e)) throw new Error("noUiSlider (" + G + "): 'margin' option must be numeric.");
        ...
        function z(t, e) {
            if (!r(e)) throw new Error("noUiSlider (" + G + "): 'limit' option must be numeric.");
        ...
        function j(t, e) {
            if (!r(e)) throw new Error("noUiSlider (" + G + "): 'padding' option must be numeric.");
            if (0 !== e) {
                if (t.padding = t.spectrum.getMargin(e), !t.padding) throw new Error("noUiSlider (" + G + "): 'padding' option is only supported on linear sliders.");
                if (t.padding < 0) throw new Error("noUiSlider (" + G + "): 'padding' option must be a positive number.");
                if (t.padding >= 50) throw new Error("noUiSlider (" + G + "): 'padding' option must be less than half the range.")
            }
        }
        ...
        function I(t, e) {
            if (t.multitouch = e, "boolean" != typeof e) throw new Error("noUiSlider (" + G + "): 'multitouch' option must be a boolean.")
        }
        ...
        function R(t, e) {
            if (!1 !== e)
                if (!0 === e) {
                    ...
                    if (t.tooltips = h(e), t.tooltips.length !== t.handles) throw new Error("noUiSlider (" + G + "): must pass a formatter for all handles.");
        ...
        function J(t, e) {
            if (void 0 !== e && "string" != typeof e && !1 !== e) throw new Error("noUiSlider (" + G + "): 'cssPrefix' must be a string or `false`.");
            t.cssPrefix = e
        }

        function Q(t, e) {
            if (void 0 !== e && "object" != typeof e) throw new Error("noUiSlider (" + G + "): 'cssClasses' must be an object.");
        ...
        function X(t, e) {
            if (!0 !== e && !1 !== e) throw new Error("noUiSlider (" + G + "): 'useRequestAnimationFrame' option should be true (default) or false.");
        ...
        function $(t) {
            ...
            t.format && !t.ariaFormat && (t.ariaFormat = t.format), Object.keys(i).forEach(function(s) {
                if (void 0 === t[s] && void 0 === a[s]) {
                    if (i[s].r) throw new Error("noUiSlider (" + G + "): '" + s + "' is required.");
                    return !0
                }
        ...
        function K(t, s, r) {
            ...
            function y(t, e) {
                ...
                return a.setAttribute("data-handle", e), a.setAttribute("tabindex", "0"), a.setAttribute("role", "slider"), a.setAttribute("aria-orientation", s.ort ? "vertical" : "horizontal"), 0 === e ? c(a, s.cssClasses.handleLower) : e === s.handles - 1 && c(a, s.cssClasses.handleUpper), i
            }
            ...
            function b(t, e, i) {
                ...
                if ("count" === t) {
                    if (!e) throw new Error("noUiSlider (" + G + "): 'values' required for mode 'count'.");
                    var a, s = 100 / (e - 1),
                        n = 0;
                    for (e = [];
                        (a = n++ * s) <= 100;) e.push(a);
            ...
            function k(t, e, i) {
                ...
                var n = {},
                    ...
                    h = !1,
                    u = 0;
                return (i = a(i.slice().sort(function(t, e) {
                    return t - e
                })))[0] !== r && (i.unshift(r), l = !0), i[i.length - 1] !== o && (i.push(o), h = !0), i.forEach(function(a, r) {
                    var o, c, d, p, f, g, m, v, y, w = a,
                        D = i[r + 1];
                    if ("steps" === e && (o = lt.xNumSteps[r]), o || (o = D - w), !1 !== w && void 0 !== D)
                        for (o = Math.max(o, 1e-7), c = w; c <= D; c = s(c, o)) {
                            for (m = (f = (p = lt.toStepping(c)) - u) / t, y = f / (v = Math.round(m)), d = 1; d <= v; d += 1) n[(u + d * y).toFixed(5)] = ["x", 0];
                            g = i.indexOf(c) > -1 ? 1 : "steps" === e ? 2 : 0, !r && l && (g = 0), c === D && h || (n[p.toFixed(5)] = [c, g]), u = p
                        }
                }), n
            }
            ...
            function C(t, e, i) {
                ...
                function n(t, n) {
                    ...
                    var o = u(r, !1);
                    o.className = a(n[1], s.cssClasses.marker), o.style[s.style] = t + "%", n[1] && ((o = u(r, !1)).className = a(n[1], s.cssClasses.value), o.style[s.style] = t + "%", o.innerText = i.to(n[0]))
                }
                var r = ct.createElement("div"),
                    o = [s.cssClasses.valueNormal, s.cssClasses.valueLarge, s.cssClasses.valueSub],
                    l = [s.cssClasses.markerNormal, s.cssClasses.markerLarge, s.cssClasses.markerSub],
                    h = [s.cssClasses.valueHorizontal, s.cssClasses.valueVertical],
                    d = [s.cssClasses.markerHorizontal, s.cssClasses.markerVertical];
                return c(r, s.cssClasses.pips), c(r, 0 === s.ort ? s.cssClasses.pipsHorizontal : s.cssClasses.pipsVertical), Object.keys(t).forEach(function(e) {
                    n(e, t[e])
                }), r
            }
            ...
            function M(t, e, i, a) {
                var n = function(n) {
                        return !st.hasAttribute("disabled") && (!p(st, s.cssClasses.tap) && (!!(n = T(n, a.pageOffset, a.target || e)) && (!(t === it.start && void 0 !== n.buttons && n.buttons > 1) && ((!a.hover || !n.buttons) && (at || n.preventDefault(), n.calcPoint = n.points[s.ort], void i(n, a))))))
                    },
                    r = [];
            ...
            function T(t, e, i) {
                var a, n, r = 0 === t.type.indexOf("touch"),
                    o = 0 === t.type.indexOf("mouse"),
                    l = 0 === t.type.indexOf("pointer");
                if (0 === t.type.indexOf("MSPointer") && (l = !0), r && s.multitouch) {
                    var h = function(t) {
                ...
                return e = e || f(ct), (o || l) && (a = t.clientX + e.x, n = t.clientY + e.y), t.pageOffset = e, t.points = [a, n], t.cursor = o || l, t
            }
            ...
            function V(t, e, i) {
                Object.keys(ut).forEach(function(a) {
                    var n = a.split(".")[0];
                    t === n && ut[a].forEach(function(t) {
                        t.call(tt, ht.map(s.format.to), e, ht.slice(), i || !1, nt.slice())
                    })
                })
            }
            ...
            function A(t, e) {
                e.handle && (d(e.handle, s.cssClasses.active), ot -= 1), e.listeners.forEach(function(t) {
                    dt.removeEventListener(t[0], t[1])
                }), 0 === ot && (d(st, s.cssClasses.drag), H(), t.cursor && (pt.style.cursor = "", pt.removeEventListener("selectstart", i))), e.handleNumbers.forEach(function(t) {
            ...
            function Y(t, e) {
                ...
                r.push.apply(r, o.concat(l, h)), t.cursor && (pt.style.cursor = getComputedStyle(t.target).cursor, K.length > 1 && c(st, s.cssClasses.drag), pt.addEventListener("selectstart", i, !1)), e.handleNumbers.forEach(function(t) {
                    V("start", t)
                })
            }
            ...
            function P(t) {
                ...
                var e = U(t.calcPoint),
                    i = E(e);
                if (!1 === i) return !1;
                s.events.snap || o(st, s.cssClasses.tap, s.animationDuration), I(i, e, !0, !0), H(), V("slide", i, !0), V("update", i, !0), V("change", i, !0), V("set", i, !0), s.events.snap && Y(t, {
                    handleNumbers: [i]
                })
            }
            ...
            function z(t, e, i, a, n, r) {
                return K.length > 1 && (a && e > 0 && (i = Math.max(i, t[e - 1] + s.margin)), n && e < K.length - 1 && (i = Math.min(i, t[e + 1] - s.margin))), K.length > 1 && s.limit && (a && e > 0 && (i = Math.min(i, t[e - 1] + s.limit)), n && e < K.length - 1 && (i = Math.max(i, t[e + 1] - s.limit))), s.padding && (0 === e && (i = Math.max(i, s.padding)), e === K.length - 1 && (i = Math.min(i, 100 - s.padding))), i = lt.getStep(i), !((i = l(i)) === t[e] && !r) && i
            }
            ...
            function R(t) {
                if (Z[t]) {
                    var e = 0,
                        i = 100;
                    0 !== t && (e = nt[t - 1]), t !== Z.length - 1 && (i = nt[t]), Z[t].style[s.style] = j(e), Z[t].style[s.styleOposite] = j(100 - i)
                }
            }

            function q(t, e) {
                null !== t && !1 !== t && ("number" == typeof t && (t = String(t)), !1 === (t = s.format.from(t)) || isNaN(t) || I(e, lt.toStepping(t), !1, !1))
            }

            function B(t, e) {
                var i = h(t),
                    a = void 0 === nt[0];
                e = void 0 === e || !!e, i.forEach(q), s.animate && !a && o(st, s.cssClasses.tap, s.animationDuration), rt.forEach(function(t) {
                    I(t, nt[t], !0, !1)
                }), H(), rt.forEach(function(t) {
            ...
            function Q(t, e) {
                ut[t] = ut[t] || [], ut[t].push(e), "update" === t.split(".")[0] && K.forEach(function(t, e) {
                    V("update", e)
                })
            }
            var X, K, Z, tt, et, it = g(),
                at = v() && m(),
                st = t,
                nt = [],
                rt = [],
                ...
                pt = ct.body;
            if (st.noUiSlider) throw new Error("noUiSlider (" + G + "): Slider was already initialized.");
            return function(t) {
                    c(t, s.cssClasses.target), 0 === s.dir ? c(t, s.cssClasses.ltr) : c(t, s.cssClasses.rtl), 0 === s.ort ? c(t, s.cssClasses.horizontal) : c(t, s.cssClasses.vertical), X = u(t, s.cssClasses.base)
                }(st),
                function(t, e) {
                    K = [], (Z = []).push(w(e, t[0]));
                    for (var i = 0; i < s.handles; i++) K.push(y(e, i)), rt[i] = i, Z.push(w(e, t[i + 1]))
                }(s.connect, X), tt = {
                    destroy: function() {
                        for (var t in s.cssClasses) s.cssClasses.hasOwnProperty(t) && d(st, s.cssClasses[t]);
                    ...
                    updateOptions: function(t, e) {
                        ...
                        a.forEach(function(e) {
                            void 0 !== t[e] && (s[e] = n[e])
                        }), lt = n.spectrum, s.margin = n.margin, s.limit = n.limit, s.padding = n.padding, s.pips && S(s.pips), nt = [], B(t.start || i, e)
                    },
                    target: st,
                    removePips: x,
                    pips: S
                ...
                function(t) {
                    t.fixed || K.forEach(function(t, e) {
                        M(it.start, t.children[0], Y, {
                            handleNumbers: [e]
                        })
                    }), t.tap && M(it.start, X, P, {}), t.hover && M(it.move, X, W, {
                        hover: !0
                        ...
                        if (!1 !== e && 0 !== i && i !== Z.length - 1) {
                            var a = K[i - 1],
                                n = K[i],
                                r = [e];
                            c(e, s.cssClasses.draggable), t.fixed && (r.push(a.children[0]), r.push(n.children[0])), r.forEach(function(t) {
                                M(it.start, t, Y, {
                                    handles: [a, n],
                                    handleNumbers: [i - 1, i]
                                })
                ...
                }(s.events), B(s.start), s.pips && S(s.pips), s.tooltips && function() {
                    var t = K.map(D);
                    Q("update", function(e, i, a) {
                        if (t[i]) {
                            var n = e[i];
                            !0 !== s.tooltips[i] && (n = s.tooltips[i].to(a[i])), t[i].innerHTML = n
                        }
                    })
